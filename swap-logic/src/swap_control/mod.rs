...
pub fn validate_sign_and_update_swapped_amount(
    ...
    for i in 0..ver1_address.len() {
        ...
        // Case 1: normal
        let mut updated_swap_request_amount = swap_request_amount[i].clone();
...
mod tests {
    ...
    pub fn test_should_verify_signature(){
        let pubkey = [String::from("02c4ef70543e18889167ca67c8aa28c1d4c259e89cb34483a8ed6cfd3a03e8246b")];
        let signature = [String::from("24899366fd3d5dfe6740df1e5f467a53f1a3aaafce26d8df1497a925c55b5c266339a95fe6\
                                      507bd611b0e3b6e74e3bb7f19eeb1165615e5cebe7f40e5765bc41")];
        let message = [String::from("69046d44e3d75d48436377626372a44a5066966b5d72c00b67769c1cc6a8619a")];
