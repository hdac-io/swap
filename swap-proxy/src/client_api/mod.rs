...
pub mod method_names {
    pub mod proxy {
        ...
        pub const NAME_SWAP_UREF: &str = "swap_uref";
...
pub enum Api {
    ...
    GetToken(Vec<String>, Vec<String>, Vec<String>, Vec<String>, Vec<U512>),
}

fn get_contract_ref() -> ContractRef {
    let contract_uref = runtime::get_key(method_names::proxy::NAME_SWAP_UREF)
        .unwrap_or_revert_with(ApiError::GetKey)
        .try_into()
        .unwrap_or_revert();
    ContractRef::URef(contract_uref)
}
    ...
    pub fn from_args() -> Self {
        ...
        match method_name.as_str() {
            ...
            method_names::proxy::METHOD_GET_TOKEN => {
                let ver1_address: Vec<String> = runtime::get_arg(1)
                    .unwrap_or_revert_with(ApiError::MissingArgument)
                    .unwrap_or_revert_with(ApiError::InvalidArgument);
                ...
                let signature: Vec<String> = runtime::get_arg(4)
                    .unwrap_or_revert_with(ApiError::MissingArgument)
                    .unwrap_or_revert_with(ApiError::InvalidArgument);
                let swap_amount: Vec<U512> = runtime::get_arg(5)
                    .unwrap_or_revert_with(ApiError::MissingArgument)
                    .unwrap_or_revert_with(ApiError::InvalidArgument);
                Api::GetToken(ver1_address, ver1_pubkey, message, signature, swap_amount)
            }
